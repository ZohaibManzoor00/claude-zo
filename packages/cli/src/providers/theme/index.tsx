...
const CONFIG_DIR = join(homedir(), ".claude-zo");
...
export function ThemeProvider({ children }: ThemeProviderProps) {
  ...
  return <ThemeContext.Provider value={{ colors: currentTheme.colors, currentTheme, setTheme }}>{children}</ThemeContext.Provider>;
}
